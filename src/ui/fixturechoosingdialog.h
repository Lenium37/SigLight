#ifndef FIXTURE_CHOOSING_DIALOG_H
#define FIXTURE_CHOOSING_DIALOG_H
...
namespace Ui {
class FixtureChoosingDialog;
}

class FixtureChoosingDialog : public QDialog {
Q_OBJECT
...
public:
   ...
   */
  void set_up_dialog_options(std::list<int> blocked_channels);
...
#endif // FIXTURE_CHOOSING_DIALOG_H
